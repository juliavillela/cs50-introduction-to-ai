...
class NimAI():
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        new_value = old_q + self.alpha * (new_estimate - old_q)
    ...
    def choose_action(self, state, epsilon=True):
        ...
        if len(all_actions):
            # if epsilon and probability of epsilon 
